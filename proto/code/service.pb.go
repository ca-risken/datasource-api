...
func (x *PutCodeScanRepositoryRequest) GetGithubSettingId() uint32 {
	if x != nil {
		return x.GithubSettingId
	}
	return 0
...
func (x *PutCodeScanRepositoryRequest) GetRepositoryFullName() string {
	if x != nil {
		return x.RepositoryFullName
	}
	return ""
...
func (x *PutCodeScanRepositoryRequest) GetStatus() Status {
	if x != nil {
		return x.Status
	}
...
func (x *PutCodeScanRepositoryRequest) GetStatusDetail() string {
	if x != nil {
...
func (x *PutCodeScanRepositoryRequest) GetScanAt() int64 {
	if x != nil {
		return x.ScanAt
	}
	return 0
...
var file_code_service_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0e, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x4e, 0x61, 0x6d,
	0x65, 0x22, 0x8a, 0x02, 0x0a, 0x1c, 0x50, 0x75, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x53, 0x63, 0x61,
	...
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x72, 0x65, 0x70,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x73, 0x63, 0x61, 0x6e, 0x41, 0x74, 0x32, 0xf2,
	0x0e, 0x0a, 0x0b, 0x43, 0x6f, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x61,
...
var file_code_service_proto_depIdxs = []int32{
	...
	39, // 15: datasource.code.PutCodeScanRepositoryRequest.status:type_name -> datasource.code.Status
