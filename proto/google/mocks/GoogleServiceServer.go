...
// NewGoogleServiceServer creates a new instance of GoogleServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGoogleServiceServer(t testing.TB) *GoogleServiceServer {
