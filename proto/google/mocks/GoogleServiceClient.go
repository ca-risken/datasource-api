...
type mockConstructorTestingTNewGoogleServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGoogleServiceClient(t mockConstructorTestingTNewGoogleServiceClient) *GoogleServiceClient {
