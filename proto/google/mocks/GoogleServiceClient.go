...
// NewGoogleServiceClient creates a new instance of GoogleServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGoogleServiceClient(t testing.TB) *GoogleServiceClient {
