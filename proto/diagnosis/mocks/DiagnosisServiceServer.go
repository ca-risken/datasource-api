...
type mockConstructorTestingTNewDiagnosisServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDiagnosisServiceServer(t mockConstructorTestingTNewDiagnosisServiceServer) *DiagnosisServiceServer {
