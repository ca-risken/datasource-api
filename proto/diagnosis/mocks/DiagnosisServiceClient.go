...
type mockConstructorTestingTNewDiagnosisServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDiagnosisServiceClient(t mockConstructorTestingTNewDiagnosisServiceClient) *DiagnosisServiceClient {
