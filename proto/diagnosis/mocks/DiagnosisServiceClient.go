...
// NewDiagnosisServiceClient creates a new instance of DiagnosisServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDiagnosisServiceClient(t testing.TB) *DiagnosisServiceClient {
