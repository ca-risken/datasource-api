...
func (_m *AWSServiceClient) AttachDataSource(ctx context.Context, in *aws.AttachDataSourceRequest, opts ...grpc.CallOption) (*aws.AttachDataSourceResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.AttachDataSourceRequest, ...grpc.CallOption) (*aws.AttachDataSourceResponse, error)); ok {
...
func (_m *AWSServiceClient) DeleteAWS(ctx context.Context, in *aws.DeleteAWSRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.DeleteAWSRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AWSServiceClient) DetachDataSource(ctx context.Context, in *aws.DetachDataSourceRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r0 *emptypb.Empty
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.DetachDataSourceRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AWSServiceClient) InvokeScan(ctx context.Context, in *aws.InvokeScanRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r0 *emptypb.Empty
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.InvokeScanRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AWSServiceClient) InvokeScanAll(ctx context.Context, in *aws.InvokeScanAllRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	var r0 *emptypb.Empty
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.InvokeScanAllRequest, ...grpc.CallOption) (*emptypb.Empty, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AWSServiceClient) ListAWS(ctx context.Context, in *aws.ListAWSRequest, opts ...grpc.CallOption) (*aws.ListAWSResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.ListAWSRequest, ...grpc.CallOption) (*aws.ListAWSResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AWSServiceClient) ListDataSource(ctx context.Context, in *aws.ListDataSourceRequest, opts ...grpc.CallOption) (*aws.ListDataSourceResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.ListDataSourceRequest, ...grpc.CallOption) (*aws.ListDataSourceResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_m *AWSServiceClient) PutAWS(ctx context.Context, in *aws.PutAWSRequest, opts ...grpc.CallOption) (*aws.PutAWSResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *aws.PutAWSRequest, ...grpc.CallOption) (*aws.PutAWSResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
// NewAWSServiceClient creates a new instance of AWSServiceClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
