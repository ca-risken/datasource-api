...
// NewOsintServiceClient creates a new instance of OsintServiceClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOsintServiceClient(t testing.TB) *OsintServiceClient {
