...
type mockConstructorTestingTNewOsintServiceClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewOsintServiceClient(t mockConstructorTestingTNewOsintServiceClient) *OsintServiceClient {
