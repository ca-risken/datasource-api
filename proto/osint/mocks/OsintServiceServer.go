...
type mockConstructorTestingTNewOsintServiceServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewOsintServiceServer(t mockConstructorTestingTNewOsintServiceServer) *OsintServiceServer {
