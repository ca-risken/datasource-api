...
// NewOsintServiceServer creates a new instance of OsintServiceServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewOsintServiceServer(t testing.TB) *OsintServiceServer {
