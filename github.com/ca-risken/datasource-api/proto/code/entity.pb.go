...
var file_code_entity_proto_goTypes = []interface{}{
	...
	(*DependencyRepositoryForUpsert)(nil), // 13: datasource.code.DependencyRepositoryForUpsert
	(*CodeScanRepositoryForUpsert)(nil),   // 14: datasource.code.CodeScanRepositoryForUpsert
	(*GitHubRepository)(nil),              // 15: datasource.code.GitHubRepository
}
var file_code_entity_proto_depIdxs = []int32{
	...
	1,  // 11: datasource.code.DependencyRepositoryForUpsert.status:type_name -> datasource.code.Status
	1,  // 12: datasource.code.CodeScanRepositoryForUpsert.status:type_name -> datasource.code.Status
