...
const (
	// TagAWS aws tag
	TagAWS = "aws"
	// TagAWSGuardduty guard-duty tag
	TagAWSGuardduty = "guard-duty"
	// TagAWSAccessAnalyzer access-analyzer tag
	TagAWSAccessAnalyzer = "access-analyzer"
	// TagAdminChecker admin-checker tag
	TagAWSAdminChecker = "admin-checker"
	// TagAWSCloudSploit cloudsploit tag
	TagAWSCloudSploit = "cloudsploit"
	// TagAWSPortscan portscan tag
	TagAWSPortscan = "portscan"

	// AWS Services

	// TagAWSUnknown unknown service tag
	TagAWSUnknown = "unknown-aws-service"
	// TagEC2 ec2 tag
	TagEC2 = "ec2"
	// TagIAM iam tag
	TagIAM = "iam"
