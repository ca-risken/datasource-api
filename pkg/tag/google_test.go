...
func TestGetGCPShortResourceName(t *testing.T) {
	...
	for _, c := range cases {
		t.Run(c.name, func(t *testing.T) {
			got := GetGCPShortResourceName(myProject, c.input)
...
func TestGetGCPServiceName(t *testing.T) {
	cases := []struct {
		name  string
		input string
		want  string
