...
type mockConstructorTestingTNewDataSourceRepoInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDataSourceRepoInterface(t mockConstructorTestingTNewDataSourceRepoInterface) *DataSourceRepoInterface {
