...
// InitializeCodeScanRepositories provides a mock function with given fields: ctx, projectID, githubSettingID, repositoryFullNames, scanAt
func (_m *CodeRepoInterface) InitializeCodeScanRepositories(ctx context.Context, projectID uint32, githubSettingID uint32, repositoryFullNames []string, scanAt time.Time) error {
	ret := _m.Called(ctx, projectID, githubSettingID, repositoryFullNames, scanAt)

	if len(ret) == 0 {
		panic("no return value specified for InitializeCodeScanRepositories")
	}
...
// RefreshCodeScanSettingStatus provides a mock function with given fields: ctx, projectID, githubSettingID, scanAt
func (_m *CodeRepoInterface) RefreshCodeScanSettingStatus(ctx context.Context, projectID uint32, githubSettingID uint32, scanAt *time.Time) error {
	ret := _m.Called(ctx, projectID, githubSettingID, scanAt)

	if len(ret) == 0 {
		panic("no return value specified for RefreshCodeScanSettingStatus")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, uint32, uint32, *time.Time) error); ok {
		r0 = rf(ctx, projectID, githubSettingID, scanAt)
	} else {
		r0 = ret.Error(0)
	}
...
// RefreshDependencySettingStatus provides a mock function with given fields: ctx, projectID, githubSettingID, scanAt
func (_m *CodeRepoInterface) RefreshDependencySettingStatus(ctx context.Context, projectID uint32, githubSettingID uint32, scanAt *time.Time) error {
	ret := _m.Called(ctx, projectID, githubSettingID, scanAt)

	if len(ret) == 0 {
		panic("no return value specified for RefreshDependencySettingStatus")
	}
...
// RefreshGitleaksSettingStatus provides a mock function with given fields: ctx, projectID, githubSettingID, scanAt
func (_m *CodeRepoInterface) RefreshGitleaksSettingStatus(ctx context.Context, projectID uint32, githubSettingID uint32, scanAt *time.Time) error {
	ret := _m.Called(ctx, projectID, githubSettingID, scanAt)

	if len(ret) == 0 {
		panic("no return value specified for RefreshGitleaksSettingStatus")
	}
