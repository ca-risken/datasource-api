...
type mockConstructorTestingTNewDiagnosisRepoInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDiagnosisRepoInterface(t mockConstructorTestingTNewDiagnosisRepoInterface) *DiagnosisRepoInterface {
