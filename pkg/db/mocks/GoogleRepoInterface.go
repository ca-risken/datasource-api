...
type mockConstructorTestingTNewGoogleRepoInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGoogleRepoInterface(t mockConstructorTestingTNewGoogleRepoInterface) *GoogleRepoInterface {
