...
type mockConstructorTestingTNewOSINTRepoInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewOSINTRepoInterface(t mockConstructorTestingTNewOSINTRepoInterface) *OSINTRepoInterface {
