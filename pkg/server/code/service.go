...
func NewCodeService(dataKey string, repo db.CodeRepoInterface, q *queue.Client, pj project.ProjectServiceClient, githubDefaultToken string, githubAppAuth *github.AppAuthConfig, limitRepositorySizeKb int, l logging.Logger) (code.CodeServiceServer, error) {
	key := []byte(dataKey)
	...
	githubClient := github.NewGithubClientWithAppAuth(githubDefaultToken, githubAppAuth, l)
