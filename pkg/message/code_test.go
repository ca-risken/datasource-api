...
func TestParseMessageGitHub(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			input: `{"github_setting_id":1, "project_id":1, "repository_name":"owner/repo", "repository":{"id":12345, "name":"repo", "full_name":"owner/repo", "clone_url":"https://github.com/owner/repo.git", "default_branch":"main", "visibility":"public", "archived":false, "fork":false, "disabled":false, "size":123, "created_at":1700000000, "pushed_at":1700003600, "html_url":"https://github.com/owner/repo"}}`,
			want: &CodeQueueMessage{
				GitHubSettingID: 1,
				ProjectID:       1,
